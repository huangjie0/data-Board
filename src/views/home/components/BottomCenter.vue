<template>
    <div class="data-home-bottom-center data-w-h">
        <TitleCard title="可研批复平均时长" icon-class="icon-qihang">
            <template #rightValue>
...
const getBarData = async ()=>{
    ...
    d.value = [];
    const res = await getKyxmTimeData({ type: btnValue1.value,time:btnValue2.value , kytype:'kypf'});
    if(res.code === 200){
